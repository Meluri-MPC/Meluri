...
export default async function TeamPage() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-400 mb-8">Manage team members and access levels</p>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-xl mx-auto text-left">
          <div className="bg-gray-800/50 rounded-lg p-4">
            <Mail size={20} className="text-velumx-400 mb-2" />
            <h3 className="text-sm font-medium mb-1">Invite by Email</h3>
            <p className="text-xs text-gray-500">Send invites to team members via email</p>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-4">
            <Shield size={20} className="text-velumx-400 mb-2" />
            <h3 className="text-sm font-medium mb-1">Role-Based Access</h3>
            <p className="text-xs text-gray-500">Admin, Developer, and Viewer roles</p>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-4">
            <Users size={20} className="text-velumx-400 mb-2" />
            <h3 className="text-sm font-medium mb-1">Shared Resources</h3>
            <p className="text-xs text-gray-500">Shared API keys and MPC configurations</p>
          </div>
        </div>
      </div>
    </div>
